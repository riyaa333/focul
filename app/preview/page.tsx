    ...
    <div style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', background: '#f0f0f0', padding: 40, minHeight: '100vh' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
        ...
        <div style={{ background: '#f9fdf6', borderRadius: 24, padding: 48, height: 480, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ width: 180, height: 2, background: '#EFF4E8', borderRadius: 4, marginBottom: 4, overflow: 'hidden' }}>
            <div style={{ width: '8%', height: '100%', background: '#3D6B47', borderRadius: 4 }} />
          </div>
          <p style={{ fontSize: 10, color: '#c0d4c0', letterSpacing: 3, textTransform: 'uppercase', marginBottom: 32 }}>focusing</p>

          {/* Tasks */}
          <div style={{ width: '100%', maxWidth: 260, borderTop: '1px solid #EFF4E8', paddingTop: 20 }}>
            ...
            {['Finish onboarding flow', 'Fix pricing page copy', 'Email 5 beta users'].map((t, i) => (
              <p key={i} style={{ fontSize: 13, color: '#5a8060', display: 'flex', gap: 8, marginBottom: 6, alignItems: 'flex-start' }}>
                <span style={{ color: '#3D6B47', flexShrink: 0 }}>→</span>{t}
              </p>
            ))}
          </div>
        </div>
        ...
        <div style={{ background: '#f9fdf6', borderRadius: 24, padding: 48, height: 480, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 4 }}>
            <span style={{ background: '#EFF4E8', color: '#3D6B47', fontSize: 11, fontWeight: 600, padding: '4px 12px', borderRadius: 20, letterSpacing: 0.5 }}>Session 3 today</span>
        ...
        <div style={{ background: '#f9fdf6', borderRadius: 24, padding: 48, height: 480, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ width: 180, height: 2, background: '#EFF4E8', borderRadius: 4, marginBottom: 4, overflow: 'hidden', position: 'relative', zIndex: 1 }}>
            <div style={{ width: '8%', height: '100%', background: '#3D6B47', borderRadius: 4 }} />
          </div>
        ...
        <div style={{ background: '#f9fdf6', borderRadius: 24, padding: 48, height: 480, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4, position: 'relative', zIndex: 1 }}>
            <span style={{ background: '#EFF4E8', color: '#3D6B47', fontSize: 10, fontWeight: 600, padding: '3px 10px', borderRadius: 20 }}>Session 3</span>
          ...
          <div style={{ width: 160, height: 2, background: '#EFF4E8', borderRadius: 4, marginBottom: 4, overflow: 'hidden', position: 'relative', zIndex: 1 }}>
            <div style={{ width: '8%', height: '100%', background: '#3D6B47', borderRadius: 4 }} />
          </div>
          ...
          <div style={{ width: '100%', maxWidth: 240, borderTop: '1px solid #EFF4E8', paddingTop: 16, position: 'relative', zIndex: 1 }}>
            {['Finish onboarding flow', 'Fix pricing page copy'].map((t, i) => (
              <p key={i} style={{ fontSize: 12, color: '#5a8060', display: 'flex', gap: 8, marginBottom: 5 }}>
                <span style={{ color: '#3D6B47' }}>→</span>{t}
              </p>
            ))}
          </div>
        </div>
